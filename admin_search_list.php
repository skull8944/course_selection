...
$sql = 'SELECT * FROM `課表_'.$_POST['admin'].'` WHERE name = "'.$_POST['name'].'"';
//$sql = "SELECT * FROM `課表_教師` WHERE name = '蘋果'";
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background: #335D70;">
            <div class="container">
                <a class="navbar-brand text-white" href="admin_search.php">管理者頁面</a>
